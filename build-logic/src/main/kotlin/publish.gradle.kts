...
fun MavenPom.configureMavenCentralMetadata(project: Project) {
    ...
    description by "A pure Kotlin/Multiplatform implementation of group operations on Curve25519."
    url by "https://github.com/andreypfau/curve25519-kotlin"
...
fun Project.configureEmptyJavadocArtifact(): Jar {
    val javadocJar by project.tasks.creating(Jar::class) {
        archiveClassifier.set("javadoc") // contents are deliberately left empty
    }
    return javadocJar
}
