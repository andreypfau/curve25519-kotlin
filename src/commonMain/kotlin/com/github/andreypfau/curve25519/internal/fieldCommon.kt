...
private val maskLow51Bits = (1uL shl 51) - 1uL

internal typealias UInt128 = ULongArray

internal inline val UInt128.lo get() = get(0)
internal inline val UInt128.hi get() = get(1)

internal inline fun mul64(a: ULong, b: ULong): UInt128 {
    val uInt128 = UInt128(2)
...
internal inline fun mulAdd64(uInt128: UInt128, a: ULong, b: ULong) = uInt128.apply {
    val hi_0 = this.hi
    val lo_0 = this.lo
...
internal inline fun shift51(a: UInt128, b: UInt128): UInt128 = b.apply {
...
internal inline fun shiftRightBy51(uInt128: UInt128): ULong {
...
// r0 = a0×b0 + 19×(a1×b4 + a2×b3 + a3×b2 + a4×b1)
    ...
    v[0] = (r0.lo and maskLow51Bits) + c4 * 19uL
...
internal fun fePow2k(fe: ULongArray, t: ULongArray, k: Int) {
    ...
    repeat(k) {
        ...
        a0 = r0.lo and maskLow51Bits
        r1 = shift51(r0, r1)

        a1 = r1.lo and maskLow51Bits
        r2 = shift51(r1, r2)

        a2 = r2.lo and maskLow51Bits
        r3 = shift51(r2, r3)

        a3 = r3.lo and maskLow51Bits
        r4 = shift51(r3, r4)

        a4 = r4.lo and maskLow51Bits
...
internal inline fun carryPropagateCommon(v: ULongArray) {
    ...
    v[0] = (v[0] and maskLow51Bits) + c4 * 19u
    v[1] = (v[1] and maskLow51Bits) + c0
    v[2] = (v[2] and maskLow51Bits) + c1
    v[3] = (v[3] and maskLow51Bits) + c2
    v[4] = (v[4] and maskLow51Bits) + c3
}
